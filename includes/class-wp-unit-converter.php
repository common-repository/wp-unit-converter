...
class Wp_Unit_Converter {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wp_Unit_Converter_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wp_Unit_Converter_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Unit_Converter_i18n. Defines internationalization functionality.
	 * - Wp_Unit_Converter_Admin. Defines all hooks for the admin area.
	 * - Wp_Unit_Converter_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wp_Unit_Converter_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp_Unit_Converter_Loader    Orchestrates the hooks of the plugin.
	 */
